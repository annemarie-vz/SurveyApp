...
function urlStaff($var2)
{
    ...
    $pullDown         = $pullDownResource->CreatePullDown('action', $searchArray, $selected = 1, $select = 1,
    ...
    $pullDown2         = $pullDownResource2->CreatePullDown('rowID', $staff, $selected = null, $select = 1,
...
function staffForm($var1, $var2)
{
    ...
    if ($row) {
        ...
        $onChangeLink     = null;
        $pullDownResource = new PullDown();
        $pullDown         = $pullDownResource->CreatePullDown("Role", $roles, $staffRow->User_Role_ID, $select = 1,
            $onChange = $onChangeLink);
        ...
        $onChangeLink     = null;
        $pullDownResource = new PullDown();
        $pullDown         = $pullDownResource->CreatePullDown("Role", $roles, $selected = null, $select = 1,
            $onChange = $onChangeLink);
